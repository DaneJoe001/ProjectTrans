...
std::optional<ClientFileInfo> ClientMessageCodec::parse_download_response(const std::vector<uint8_t>& body)
{
...
std::optional<BlockResponseInfo> ClientMessageCodec::parse_block_response(const std::vector<uint8_t>& body)
{
...
std::string ClientMessageCodec::parse_test_response(const std::vector<uint8_t>& body)
{
    DaneJoe::SerializeCodec serializer;
...
std::optional<DaneJoe::Protocol::RequestInfo> ClientMessageCodec::parse_response(const std::vector<uint8_t>& data)
{
...
std::vector<uint8_t> ClientMessageCodec::build_request(DaneJoe::Protocol::RequestInfo info)
{
...
std::vector<uint8_t> ClientMessageCodec::build_test_request(const DaneJoe::UrlInfo url_info, const std::string& message)
{
    // 构建消息体
    DaneJoe::SerializeCodec serializer;
...
std::vector<uint8_t> ClientMessageCodec::build_block_request(const DaneJoe::UrlInfo url_info, const BlockRequestInfo& block_request_info)
{
    DANEJOE_LOG_TRACE("default", "ClientMessageCodec", "Building block request for block: {}", block_request_info.to_string());
    DaneJoe::SerializeCodec serializer;
...
std::vector<uint8_t> ClientMessageCodec::build_download_request(const DaneJoe::UrlInfo url_info, const std::string& account, const std::string& password)
{
    DANEJOE_LOG_TRACE("default", "ClientMessageCodec", "Query params: {}", DaneJoe::to_string(url_info.query));
    // 构建消息体
    DaneJoe::SerializeCodec serializer;
    /// @todo 解析url,获取文件id
