...
if(ADD_QT_LIB)
    ...
    if(TARGET ${CLIENT_CORE_LIB_NAME})
        set_target_properties(${CLIENT_CORE_LIB_NAME} PROPERTIES
            AUTOMOC ON
            AUTORCC ON
            AUTOUIC ON
        )
    endif()
    if(TARGET ${CLIENT_EXECUTABLE_NAME})
    ...
    foreach(qt_component IN LISTS QT_COMPONENTS)
        target_link_libraries(${CLIENT_CORE_LIB_NAME} PUBLIC Qt6::${qt_component})
    endforeach()
endif()
...
if(USE_SQLITECPP)
    ...
    target_link_libraries(${CLIENT_CORE_LIB_NAME} PRIVATE SQLiteCpp)
endif()

target_link_libraries(${CLIENT_CORE_LIB_NAME} PRIVATE OpenSSL::SSL)
target_link_libraries(${CLIENT_CORE_LIB_NAME} PRIVATE OpenSSL::Crypto)
